         ...
         onPress={() => setModalVisible(!modalVisible)}
          ...
          <Pressable>
            ...
            <Text
              ...
              Deliver to Kapil - Bangalore 56745
            </Text>
          </Pressable>
          <Image
            source={{
...
{/*------------------- Carausal List--------------------------------------------------------- */}
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          <Image
            ...
            style={{width: '450', height: 220,resizeMode:'cover',padding:6}}
          />
        </ScrollView>
      ...
      >
        <ModalContent style={{ width: "100%", height: 400 }}>
          ...
          <View style={{ flexDirection: "column", gap: 7, marginBottom: 30 }}>
            ...
            >
              <Image style={{height:22,width:22}} source={{uri:"https://cdn-icons-png.flaticon.com/128/18598/18598802.png"}}/>
            ...
            <View
              style={{ flexDirection: "row", alignItems: "center", gap: 5 }}
            >
              <Image style={{height:22,width:22}} source={{uri:"https://cdn-icons-png.flaticon.com/128/565/565949.png"}}/>
              <Text style={{ color: "#0066b2", fontWeight: "400" }}>
            ...
            <View
              style={{ flexDirection: "row", alignItems: "center", gap: 5 }}
            >
             <Image style={{height:22,width:22}} source={{uri:"https://cdn-icons-png.flaticon.com/128/3083/3083741.png"}}/>
              <Text style={{ color: "#0066b2", fontWeight: "400" }}>
